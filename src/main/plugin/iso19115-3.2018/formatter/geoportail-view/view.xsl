          ...
          <h2>
            <xsl:choose>
              <xsl:when test="$metadata/mdb:identificationInfo/*/mri:citation/*/cit:title!=''">
                <xsl:for-each select="$metadata/mdb:identificationInfo/*/mri:citation/*/cit:title">
        ...
        <div class="row">
          <p>
            <xsl:for-each select="$metadata/mdb:identificationInfo/*/mri:abstract">
              ...
              <xsl:value-of select="substring-before(translate($txt,'?!','..'),'.')"/>.
            </xsl:for-each>
          </p>
        </div>
        <div class="row">
          ...
          <xsl:when test="$metadata/mdb:identificationInfo/*/mri:descriptiveKeywords[
            ...
            <xsl:if test="$metadata/mdb:identificationInfo/*/mri:descriptiveKeywords[
              ...
              <p>
                <xsl:for-each select="$metadata/mdb:identificationInfo/*/mri:descriptiveKeywords[
                              contains(*/mri:thesaurusName/*/cit:title/gco:CharacterString,
                                           'GEMET - INSPIRE themes, version 1.0')]/*/mri:keyword">
                <xsl:variable name="txt">
                  <xsl:call-template name="get-iso19115-3.2018-localised">
                    <xsl:with-param name="langId" select="$langId"/>
                  </xsl:call-template>
            ...
            <xsl:if test="$metadata/mdb:identificationInfo/*/mri:descriptiveKeywords[
              ...
              <p>
                <xsl:for-each select="$metadata/mdb:identificationInfo/*/mri:descriptiveKeywords[
                              contains(*/mri:thesaurusName/*/cit:title/gco:CharacterString,
                                           'GEMET - Concepts, version 2.4')]/*/mri:keyword">
                  <xsl:variable name="txt">
                    <xsl:call-template name="get-iso19115-3.2018-localised">
                      <xsl:with-param name="langId" select="$langId"/>
                    </xsl:call-template>
      ...
      <div class="rw-fr-geoportail-section-content">
        <xsl:choose>
          <xsl:when test="$metadata/mdb:identificationInfo/*/mri:descriptiveKeywords[not(*/mri:thesaurusName)]/*/mri:keyword">
            <p><xsl:for-each select="$metadata/mdb:identificationInfo/*/mri:descriptiveKeywords[not(*/mri:thesaurusName)]/*/mri:keyword">
              <xsl:variable name="txt">
                <xsl:call-template name="get-iso19115-3.2018-localised">
                  <xsl:with-param name="langId" select="$langId"/>
                </xsl:call-template>
